        ...
        <section>
            ...
            <ul>
                ...
                <li>
                    ...
                    <input id="github" name="github" max="256" onChange={e => changeContact(e.target.value, 3)}></input>
                    </p>
                </li>
                {contacts.slice(4, contacts.length).map((c,i) => {return <li key={"otherContactInput-" + i}>{createContactInput(4+i)}</li>})}
            </ul>
